...
define('DB_NAME', 'nouvelingenieur_refresh');

/** Utilisateur de la base de données MySQL. */
define('DB_USER', 'nouvelingenieur');

/** Mot de passe de la base de données MySQL. */
define('DB_PASSWORD', 'iletait1fois');
...
define('PREGMATCH_MAIL', '#^([a-z][\-_]?)*[a-z]+\.([a-z0-9][\-_]?)*[a-z]+@\.ecole\.fr$#'); // regular expression 
